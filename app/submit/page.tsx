          ...
          <div className="sticky top-24 space-y-4">
            ...
            <Card className="border-border/60">
              <CardContent className="p-5">
                <h3 className="text-sm font-semibold mb-3">Get listed faster</h3>
                <p className="text-xs text-muted-foreground mb-4">
                  DM with your tool details and layer(s) for priority review.
                </p>
                <div className="space-y-3 mb-4">
                  <p className="text-xs text-muted-foreground font-medium">AI Stack Layers:</p>
                  <div className="flex flex-wrap gap-1">
                    <span className="text-xs px-2 py-1 rounded bg-muted">Compute & Hardware</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Foundation Models</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Inference & Hosting</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Training & Fine-Tuning</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Data & Vector</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Orchestration</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Execution & Sandbox</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Observability & Safety</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Application & Agents</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Terminal & Productivity</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Design & Video</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Audio & Voice</span>
                    <span className="text-xs px-2 py-1 rounded bg-muted">Communication</span>
                  </div>
                </div>
